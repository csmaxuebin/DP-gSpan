...
public class Graph extends ArrayList<Vertex> {
        ...
        while ((line = is.readLine()) != null) {
            ...
            if (!result.isEmpty()) {
                if (result.get(0).equals("t")) {
                    //System.out.println(" --------------------------");
                    //System.out.println(!this.isEmpty());false
                    if (!this.isEmpty()) { // use as delimiter
                        break;
                    }
                } else if (result.get(0).equals("v") && result.size() >= 3) {//行数
                    //System.out.println(" --------------------------");
                    ...
                    //System.out.println(this.size()+"<=" +from+" "+this.size()+"<=" + to);
    ...
    public void write(FileWriter os) throws IOException {
        ...
        os.write("C "+count+ System.getProperty("line.separator"));
        os.flush();
    }
